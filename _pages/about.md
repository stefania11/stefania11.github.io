...
Hi! I am Stefania. I am currently an AI Resident at [X Moonshot Factory](https://x.company/) and a third-year Ph.D. Candidate 🎓 at the University of Washington Information School, advised by Prof. [Amy J. Ko](https://faculty.washington.edu/ajko/) in the [Code & Cognition Lab](https://faculty.washington.edu/ajko/lab). I am also affiliated with the [PLSE Lab](http://uwplse.org/) and with the [Community Data Science Collective](https://wiki.communitydata.science/Main_Page). 

My research focuses on Computer-Supported Coding and the design of AI Literacies tools and resources for Families 📚. I also enjoy designing and building future smart toys 🤖 and games. When I am not coding & writing papers 👩🏽‍💻 I love hiking, climbing, and riding my 🚲.
