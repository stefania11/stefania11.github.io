...
export default function BlogPage() {
  ...
  const blogMatchesActiveTag = (post: any) => {
  ...
  const blogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      coverImage: "https://images.unsplash.com/photo-1618477461853-cf6ed80faba5?q=80&w=1664&auto=format&fit=crop",
    ...
    },
    {
      ...
      date: "July 5, 2023",
      author: "Stefania Druga",
      excerpt: "Highlights and lessons from the first Fixie Hackathon in Seattle, exploring the capabilities and limitations of AI agent technologies.",
    ...
    },
    {
      ...
      date: "June 22, 2023",
      author: "Stefania Druga",
      excerpt: "A systematic analysis of existing AI education resources and how they can be effectively used in different learning contexts.",
      coverImage: "https://images.unsplash.com/photo-1509062522246-3755977927d7?q=80&w=1864&auto=format&fit=crop",
      tags: ["AI Education", "Family Learning"],
                          ...
                          {post.tags.map((tag) => {
                            ...
                            return (
                              <span
                                ...
                                style={{
                                  backgroundColor: tagObject?.color || 'rgba(224, 214, 255, 0.5)'
                                }}
                              >
                                {tag}
                              </span>
